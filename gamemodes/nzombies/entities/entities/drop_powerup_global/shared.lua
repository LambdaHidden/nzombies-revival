...
ENT.PrintName		= "drop_powerups_global"
ENT.Author			= "Alig96"
ENT.Contact			= "Don't"
ENT.Purpose			= ""
ENT.Instructions	= ""
...
if CLIENT then
	...
	function ENT:Draw()
		if CurTime() > self.NextParticle then
			...
			util.Effect( "powerup_glow_global", effectdata )
	...
	hook.Add( "PreDrawHalos", "drop_powerups_halos_global", function()
		halo.Add( ents.FindByClass( "drop_powerup_global" ), Color( 50, 175, 50 ), 8, 8, 6 )
	end )
end