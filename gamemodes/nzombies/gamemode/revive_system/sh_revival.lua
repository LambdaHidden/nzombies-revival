...
function nzRevive:CreateWhosWhoClone(ply, pos)
	...
	--[[for i=1, #self:GetWeapons() do
		...
		table.insert(ply.OldWeps, {class = v:GetClass(), ammo1 = ply:GetAmmoCount( v:GetPrimaryAmmoType() ), ammo2 = ply:GetAmmoCount( v:GetSecondaryAmmoType() ), modifiers = v.NZModifiers or {}})
	end]]
