...
nzConfig.AddWeaponToBlacklist( "nz_grenade_backup" )
nzConfig.AddWeaponToBlacklist( "nz_semtex" )
nzConfig.AddWeaponToBlacklist( "nz_perk_bottle" )
nzConfig.AddWeaponToBlacklist( "nz_quickknife_crowbar" )
nzConfig.AddWeaponToBlacklist( "nz_quickknife_crowbar_backup" )
nzConfig.AddWeaponToBlacklist( "nz_knife" )
